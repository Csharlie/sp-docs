...
canonical: ../phase-8.5/p8.5-seed-pipeline.md
---

Típusnézet. Kanonikus dokumentum: [phase-8.5/p8.5-seed-pipeline.md](../phase-8.5/p8.5-seed-pipeline.md)
...
- [p8.5-parity-gate.md](../phase-8.5/p8.5-parity-gate.md) — CMS Runtime Parity Gate guardrail
- [p8.5-group-key-normalization.md](../phase-8.5/p8.5-group-key-normalization.md) — ACF group sub-field kulcs-normalizálás
- [p8.5-image-sideload.md](../phase-8.5/p8.5-image-sideload.md) — Image sideloading a pipeline-ban
