...
canonical: ../phase-8.5/p8.5-image-sideload.md
---

Típusnézet. Kanonikus dokumentum: [phase-8.5/p8.5-image-sideload.md](../phase-8.5/p8.5-image-sideload.md)
...
- [p8.5-seed-pipeline.md](../phase-8.5/p8.5-seed-pipeline.md) — a pipeline, amelynek a 2. lépése (import) végzi a sideload-ot
- [p8.5-parity-gate.md](../phase-8.5/p8.5-parity-gate.md) — az endpoint smoke test, amely a sideload eredményét ellenőrzi
